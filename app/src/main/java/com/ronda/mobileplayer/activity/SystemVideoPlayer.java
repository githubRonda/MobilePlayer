...
import com.ronda.mobileplayer.view.VideoView;
...
//        screenHeight = getWindowManager().getDefaultDisplay().getHeight();
    ...
    public void onClick(View v) {
        if (v == btnVoice) {
            ...
            // 有一种视频, 播放不报错, 但是只有声音, 没有画面, 这是就不会自动跳转到万能播放器界面, 只能手动点击此按钮跳转
...
//        Log.e(TAG, "lp.screenBrightness= " + lp.screenBrightness);
    ...
    class MyOnPreparedListener implements MediaPlayer.OnPreparedListener {
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            //1.视频的总时长，关联总长度
            int duration = videoview.getDuration();// mp.getDuration(); 也是可以的, 本质上都是调用mMediaPlayer.getDuration()
