...
public class LoginActivity extends BaseActivity {
    ...
    private void initViews() {
        ...
        this.mVendorKey.setText(getSharedPreferences(getClass().getName(), Context.MODE_PRIVATE).getString(ChannelActivity.EXTRA_VENDOR_KEY, "029f18c9a77b4219af2a6d7b0bf53e32"));
        this.mChannelID.setText(getSharedPreferences(getClass().getName(), Context.MODE_PRIVATE).getString(ChannelActivity.EXTRA_CHANNEL_ID, "123456"));
